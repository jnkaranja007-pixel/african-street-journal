...
$split  = Split-ShippableByCountry $byCountry
$shipBy = $split.index
$fullBy = $split.full
...
# The deferred half: paragraphs, why lines, lens explanations and source URLs, keyed by
# articleId. app.js loads it after first paint, so it never delays the map.
$fullPath = Join-Path $root 'data\briefs-full.js'
$fullPayload = "// Auto-generated by scripts/add-briefs.ps1 - the deferred half of the edition.`r`n" +
...
$archPayload = "// The African Street Journal - archived edition $day (auto-generated).`r`n" +
               "window.__ASJ_ARCHIVE_DAY = { date: '$day', generated: '$generated', byCountry: $(ConvertTo-CountryJsBlock (ConvertTo-ShippableByCountry $byCountry)), markets: $(ConvertTo-JsBlock $markets) };`r`n"
